        ...
        var prometheus = new Container(
            ...
            new ContainerArgs
            {
                ...
                Volumes =
                {
                    new ContainerVolumeArgs
                    {
                        HostPath = "./docker/prometheus/prometheus.yml",
        ...
        var grafana = new Container(
            ...
            new ContainerArgs
            {
                ...
                Volumes =
                {
                    new ContainerVolumeArgs
                    {
                        HostPath = "./docker/grafana/grafana.ini",
        ...
        var tempo = new Container(
            ...
            new ContainerArgs
            {
                ...
                Volumes =
                {
                    new ContainerVolumeArgs
                    {
                        HostPath = "./docker/grafana/tempo.yml",
                        ContainerPath = "/etc/tempo.yml",
                    },
                },
            }
        );
