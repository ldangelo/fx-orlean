...
resource "aws_eks_node_group" "main" {
  ...
  remote_access {
    ...
    source_security_group_ids = var.worker_additional_security_group_ids
  }
...
resource "aws_iam_role_policy" "node_group_CloudWatchAgentServerPolicy" {
  name = "${var.cluster_name}-CloudWatchAgentServerPolicy"
