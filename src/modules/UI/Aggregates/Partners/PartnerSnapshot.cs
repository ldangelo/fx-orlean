...
public record PartnerSnapshot(string emailAddress, string firstName, string lastName, List<String> skills, List<IVideoConferenceGrain> videoConferences): ISnapshot;
